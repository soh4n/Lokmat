...
class TestComputeStatus:
    ...
    def test_upcoming_before_nomination(self):
    ...
    def test_nomination_during_filing(self):
    ...
    def test_polling_during_voting(self):
    ...
    def test_counting_after_polling(self):
    ...
    def test_completed_after_results(self):
...
class TestComputePhase:
    ...
    def test_phase_before_polling(self):
    ...
    def test_phase_between_phases(self):
...
class TestGetLiveElection:
    ...
    def test_no_live_when_all_completed(self, mock_today):
    ...
    @patch("api.services.election_calendar._get_ist_today")
    def test_live_during_polling(self, mock_today):
    ...
    @patch("api.services.election_calendar._get_ist_today")
    def test_live_returns_correct_election(self, mock_today):
    ...
    @patch("api.services.election_calendar._get_ist_today")
    def test_polling_priority_over_nomination(self, mock_today):
    ...
    @patch("api.services.election_calendar._get_ist_today")
    def test_response_has_progress(self, mock_today):
...
class TestGetUpcomingElections:
    ...
    @patch("api.services.election_calendar._get_ist_today")
    def test_excludes_completed(self, mock_today):
    ...
    @patch("api.services.election_calendar._get_ist_today")
    def test_sorted_by_polling_start(self, mock_today):
    ...
    @patch("api.services.election_calendar._get_ist_today")
    def test_respects_limit(self, mock_today):
